        ...
        <div className="container-fluid footer-style">
           <div className="row">
                <div className="col-12">
                    <a href="#/about"><Button className="back">Back To Top</Button></a>
                </div>
                <div className="col-12">
                    ...
                    <a href="https://www.codewars.com/users/jethoo" target="_blank"><Button className="social">Codewars</Button></a>
